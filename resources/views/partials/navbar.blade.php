                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ url('user/about') }}"
                                class="{{ Request::is('user/about') ? 'bg-gray-900 text-white' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About
                            </a>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="hidden lg:block flex justify-center mx-3">
                        <div class="xl:w-45">
                            <div class="input-group relative flex flex-wrap items-stretch w-full">
                                <form class="d-flex" action="{{ url('user/post') }}">
                                    <input type="search"
                    ...
                    <div class="hidden overflow-x-hidden overflow-y-auto fixed-top inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                        ...
                        <div class="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <button
                                class="text-blue-600 pt-4 item-align-center text-sm rounded-full background-transparent outline-none focus:outline-none mr-1 ease-linear transition-all duration-200"
    ...
    @auth
        <div class="hidden menus-item" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ url('user/about') }}"
                    class="{{ Request::is('user/about') ? 'bg-gray-900 text-white' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">About
                </a>
