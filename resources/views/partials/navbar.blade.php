                ...
                @auth
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="#"
                                class="{{ Request::is('saved') ? 'bg-gray-900 text-white' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Saved
                            </a>
    ...
    @auth
        <div class="hidden menus-item" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="#"
                    class="{{ Request::is('saved') ? 'bg-gray-900 text-white' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Saved
                </a>
