<footer class="mt-4 text-center text-white" style="background-color: #f1f1f1;">
    <div class="container pt-10">
        @auth
            <div class="flex justify-center mb-9">
                <a href="{{ auth()->user()->fb_account ? auth()->user()->fb_account : '#!' }}" class="mr-9 text-gray-800">
                ...
                <a href="{{ auth()->user()->twt_account ? auth()->user()->twt_account : '#!' }}" class="mr-9 text-gray-800">
                ...
                <a href="{{ auth()->user()->ig_account ? auth()->user()->ig_account : '#!' }}" class="mr-9 text-gray-800">
        ...
        @else
            <div class="flex-1 flex items-center justify-center">
                <div class="flex-shrink-0 flex items-center">
                    <img class="block h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg"
                        alt="Workflow">
                </div>
            </div>
        @endauth
    </div>
    <div class="mt-10 text-center text-gray-700 p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2022 Copyright
