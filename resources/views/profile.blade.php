                ...
                <ul class="py-1" aria-labelledby="dropdownButton">
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <span class="inline-block h-25 w-25 rounded-full overflow-hidden bg-gray-100">
                            @if ($user->photo)
                                <img id="output" class="h-full w-full" src="{{ asset('storage/' . $user->photo) }}">
                            @else
                        ...
                        <span class="text-sm text-gray-500 pb-4 dark:text-gray-400">{{ $user->username }}</span>
                        <div class="flex mt-4 space-x-3 md:mt-8">
                            <div class="flex justify-center mb-4">
                                <a href="{{ $user->fb_account ? $user->fb_account : '#!' }}" class="mr-9 text-gray-800">
                ...
                <div class="card-group" id="posts">
                    <div class="row row-cols-md-1 g-3 mb-2 my-3">
                        @foreach ($user->posts as $post)
                            ...
                            @empty($posts)
                                <div class="col-md-8">
                                    <h1 class="text-gray-500 text-center text-sm">Post not found.</h1>
                                </div>
                            @endempty
                        @endforeach
                    </div>
